...
<div class="main-container">
    <div class="container-fluid">
        <div class="row gutter">
          ...
          <div class="col-lg-6">
            <button class="btn btn-danger pull-left"><i class="fa fa-plus"></i> Add New Student</button>
              </div>
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pull-right"><div class="form-group has-feedback">
                                                                      ...
                                                                      <button type="button" class="btn btn-primary btn-xs" title="Edit Student"><i class="fa fa-pencil" ></i> </button>
                                                                       ...
                                                                       <button type="button" class="btn btn-primary btn-xs"><i class="fa fa-mobile" title="Send SMS"></i> </button>
                                                                              ...
                                                                              <tr>
                                                                                ...
                                                                                <td>Lavish Gangwar</td>
                                                                                <td>+91 9718789479</td>
                                                                                <td>lavishgdrwertrtrtan@gmail.com</td>
                                                                                <td>22</td>
                                                                                <td>DPS125986</td>
                                                                                <td>DPS125986</td>
                                                                                <td><label class="switch">
